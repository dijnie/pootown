...
export const PAY_JAIL_FINE_DISCRIMINATOR = new Uint8Array([
  93, 72, 206, 3, 8, 70, 76, 112,
]);

export function getPayJailFineDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    PAY_JAIL_FINE_DISCRIMINATOR
  );
}

export type PayJailFineInstruction<
...
export type PayJailFineInstructionData = { discriminator: ReadonlyUint8Array };

export type PayJailFineInstructionDataArgs = {};

export function getPayJailFineInstructionDataEncoder(): FixedSizeEncoder<PayJailFineInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: PAY_JAIL_FINE_DISCRIMINATOR })
  );
}

export function getPayJailFineInstructionDataDecoder(): FixedSizeDecoder<PayJailFineInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getPayJailFineInstructionDataCodec(): FixedSizeCodec<
  PayJailFineInstructionDataArgs,
  PayJailFineInstructionData
> {
  return combineCodec(
    getPayJailFineInstructionDataEncoder(),
    getPayJailFineInstructionDataDecoder()
  );
}

export type PayJailFineAsyncInput<
...
export async function getPayJailFineInstructionAsync<
  TAccountGame extends string,
  TAccountPlayerState extends string,
  TAccountPlayer extends string,
  TAccountClock extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getPayJailFineInstructionDataEncoder().encode({}),
    programAddress,
  } as PayJailFineInstruction<
    TProgramAddress,
    TAccountGame,
    TAccountPlayerState,
    TAccountPlayer,
...
export function getPayJailFineInstruction<
  TAccountGame extends string,
  TAccountPlayerState extends string,
  TAccountPlayer extends string,
  TAccountClock extends string,
...
export type ParsedPayJailFineInstruction<
  TProgram extends string = typeof PANDA_MONOPOLY_PROGRAM_ADDRESS,
...
> = {
  ...
  data: PayJailFineInstructionData;
};

export function parsePayJailFineInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedPayJailFineInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getPayJailFineInstructionDataDecoder().decode(instruction.data),
  };
}
