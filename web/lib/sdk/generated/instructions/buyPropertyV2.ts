...
export const BUY_PROPERTY_V2_DISCRIMINATOR = new Uint8Array([
  158, 42, 103, 199, 142, 65, 25, 181,
]);

export function getBuyPropertyV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    BUY_PROPERTY_V2_DISCRIMINATOR
  );
}

export type BuyPropertyV2Instruction<
...
export type BuyPropertyV2InstructionData = {
  discriminator: ReadonlyUint8Array;
  position: number;
};

export type BuyPropertyV2InstructionDataArgs = { position: number };

export function getBuyPropertyV2InstructionDataEncoder(): FixedSizeEncoder<BuyPropertyV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['position', getU8Encoder()],
    ]),
    (value) => ({ ...value, discriminator: BUY_PROPERTY_V2_DISCRIMINATOR })
  );
}

export function getBuyPropertyV2InstructionDataDecoder(): FixedSizeDecoder<BuyPropertyV2InstructionData> {
...
export function getBuyPropertyV2InstructionDataCodec(): FixedSizeCodec<
  BuyPropertyV2InstructionDataArgs,
  BuyPropertyV2InstructionData
> {
  return combineCodec(
    getBuyPropertyV2InstructionDataEncoder(),
    getBuyPropertyV2InstructionDataDecoder()
  );
}

export type BuyPropertyV2AsyncInput<
...
> = {
  ...
  position: BuyPropertyV2InstructionDataArgs['position'];
};

export async function getBuyPropertyV2InstructionAsync<
  TAccountGame extends string,
  TAccountPlayerState extends string,
  TAccountPlayer extends string,
  TAccountClock extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getBuyPropertyV2InstructionDataEncoder().encode(
      args as BuyPropertyV2InstructionDataArgs
    ),
    programAddress,
  } as BuyPropertyV2Instruction<
    TProgramAddress,
    TAccountGame,
    TAccountPlayerState,
    TAccountPlayer,
...
export type BuyPropertyV2Input<
  TAccountGame extends string = string,
  TAccountPlayerState extends string = string,
  TAccountPlayer extends string = string,
  TAccountClock extends string = string,
...
export function getBuyPropertyV2Instruction<
  TAccountGame extends string,
  TAccountPlayerState extends string,
  TAccountPlayer extends string,
  TAccountClock extends string,
...
export type ParsedBuyPropertyV2Instruction<
  TProgram extends string = typeof PANDA_MONOPOLY_PROGRAM_ADDRESS,
...
> = {
  ...
  data: BuyPropertyV2InstructionData;
};

export function parseBuyPropertyV2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedBuyPropertyV2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getBuyPropertyV2InstructionDataDecoder().decode(instruction.data),
  };
}
