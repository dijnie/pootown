...
export function PlayerProfileModal({
  ...
  const avatar = getAvatarForPlayer(player.playerId);
  const losses = Math.max(0, player.gamesPlayed - player.gamesWon);
  const winRate =
    player.gamesPlayed === 0 ? 0 : (player.gamesWon / player.gamesPlayed) * 100;
          ...
          <DialogTitle className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 flex items-center gap-2 text-sm text-muted-foreground">
                <span className="truncate" title={player.playerId}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <Card className="sm:col-span-2">
            ...
            <CardContent className="grid grid-cols-3 gap-4">
              ...
              <div>
                <div className="text-2xl font-bold">{player.gamesWon}</div>
